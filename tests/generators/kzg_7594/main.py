...
def case_compute_cells():
    ...
    for blob in INVALID_BLOBS:
        ...
        identifier = make_id(blob)
        yield f"compute_cells_invalid_blob_{identifier}", {"input": {"blob": encode_hex(blob)}, "output": None}
...
def create_provider(
    fork_name: SpecForkName, handler_name: str, test_case_fn: Callable[[], Iterable[Tuple[str, Dict[str, Any]]]]
