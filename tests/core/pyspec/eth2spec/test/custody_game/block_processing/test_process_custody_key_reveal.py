...
def run_custody_key_reveal_processing(spec, state, custody_key_reveal, valid=True):
    ...
    pre_next_custody_secret_to_reveal = state.validators[revealer_index].next_custody_secret_to_reveal

    spec.process_custody_key_reveal(state, custody_key_reveal)

    post_next_custody_secret_to_reveal = state.validators[revealer_index].next_custody_secret_to_reveal
