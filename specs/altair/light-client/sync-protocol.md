...
def is_better_update(
    ...
    new_has_relevant_sync_committee = is_sync_committee_update(
        new_update
    ) and (
    ...
    old_has_relevant_sync_committee = is_sync_committee_update(
        old_update
    ) and (
        compute_sync_committee_period_at_slot(
...
def validate_light_client_update(
    ...
    assert (
        sum(sync_aggregate.sync_committee_bits)
