...
def get_valid_attestation(
    spec, state, slot=None, index=None, filter_participant_set=None, beacon_block_root=None, signed=False
):
    """
    ...
    fill_aggregate_attestation(
        spec, state, attestation, signed=signed, filter_participant_set=filter_participant_set, committee_index=index
    )
...
def state_transition_with_full_block(
    spec, state, fill_cur_epoch, fill_prev_epoch, participation_fn=None, sync_aggregate=None, block=None
):
    """
