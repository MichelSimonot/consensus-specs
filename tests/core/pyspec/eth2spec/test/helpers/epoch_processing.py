...
def get_process_calls(spec):
    ...
    return [
        ...
        "process_historical_summaries_update" if is_post_capella(spec) else ("process_historical_roots_update"),
        # Altair replaced `process_participation_record_updates` with `process_participation_flag_updates`
        "process_participation_flag_updates" if is_post_altair(spec) else ("process_participation_record_updates"),
